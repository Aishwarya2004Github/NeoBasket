...
const UploadSubCategoryModel = ({ close, fetchData }) => {
  ...
  const handleSubmitSubCategory = async (e) => {
    ...
    console.log("SUBMIT DATA => ", subCategoryData);
  ...
  return (
    <section className="fixed inset-0 bg-neutral-900/70 z-50 flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="w-full max-w-xl bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden border border-neutral-100 animate-in zoom-in-95 duration-150">
        
        {/* Modal Header */}
        <div className="p-4 border-b border-neutral-100 flex items-center justify-between bg-neutral-50/50">
          <h1 className="font-bold text-lg text-neutral-800">Add Sub Category</h1>
        ...
        >
          ...
          <div className="grid gap-1.5">
            <label htmlFor="subCategoryName" className="text-sm font-semibold text-neutral-700">Sub Category Name</label>
            <input
              id="subCategoryName"
              type="text"
              name="name"
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 bg-neutral-50 p-3 rounded-lg border border-neutral-100">
              ...
              <div className="flex flex-col items-center sm:items-start gap-1 w-full">
                <label htmlFor="uploadSubCategoryImage">
                  <div className="px-4 py-2 border border-primary-100 text-primary-200 text-sm font-semibold rounded-lg hover:bg-primary-200 hover:text-neutral-900 cursor-pointer bg-white shadow-sm transition-all">
                    Upload Image
                  </div>
          ...
          <div className="pt-2">
            <button
              type="submit"
              className={`w-full py-2.5 px-4 rounded-lg font-bold text-sm shadow-sm transition-all duration-150 text-center
              ${
